    ...
    <div className="space-y-6">
                    ...
                    >
                      ...
                      <TableCell>
                        {record.time_out ? (
                          ...
                          <Badge
                            variant="outline"
                            className="border-amber-200 text-amber-700 w-fit"
                          >
                            In Progress
                          </Badge>
                        )}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link
            to="/employees"
            className="group p-6 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg hover:border-pink-300 transition-all duration-300 text-left no-underline"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  View, add, edit employee records
                </p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Manage announcements</p>
              </div>
            </div>
          </Link>

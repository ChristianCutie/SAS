        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-blue-900">Active Students</p>
                ...
                <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-emerald-900">Regular Status</p>
            ...
            <Card className="border-slate-200 shadow-sm">
                <CardHeader className="border-b border-slate-100">
                    <CardTitle>
                        {showArchived ? 'Archived Student Records' : 'Active Student Records'}
                    </CardTitle>
                </CardHeader>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="hover:bg-transparent">
                                        ...
                                        <TableHead className="font-semibold text-slate-700">Course & Section</TableHead>
                                        <TableHead className="font-semibold text-slate-700">RFID Tag</TableHead>
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <div>
                                                    ...
                                                    <div className="text-sm text-slate-500">{student.section_name}</div>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                    ...
                                                    {showArchived ? (
                                                        <>
                                                            <Button
                                                                ...
                                                                onClick={() => handleRestore(student.id, `${student.first_name} ${student.last_name}`)}
                                                            >
